 ...
 * Client.java
 * Author: Oliver et al.
 * Control point for client-side functionality.
 */
...
public class Client {
    ...
    public static String[] getConnection() {
        ...
        // Create the text fields for the hostname and port
        JTextField hostnameField = new JTextField(20);
        JTextField portField = new JTextField(20);

        // Component array for the dialog box
        Object[] message = {
    ...
    public boolean run() {
        try {
            ...
            properties.setProperty("server", hostname);
            properties.setProperty("port", String.valueOf(port));

            // Gets and checks the password provided by the user
            String response = "";
            String password = "";
            // something strange goes on here with the password
