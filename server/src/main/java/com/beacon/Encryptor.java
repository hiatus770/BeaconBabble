 ...
 * Encryptor.java
 * Author: Jerry Wu
 * Purpose: This class is responsible for encrypting and decrypting messages.
 * It uses the XOR encryption algorithm.
 */
package com.beacon;
...
public class Encryptor {
    private String key; // Key to encrypt/decrypt message, usually the password of the application 
